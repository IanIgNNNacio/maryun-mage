...
TABLE_CURRENT = 'dwh.nominas_jp_mongo'
TABLE_HISTORY = 'dwh.nominas_jp_mongo_history'
...
DECIMAL_COLS = {'nomina_amount'}
DATETIME_COLS = {'ingested_at', 'snapshot_at'}
STRING_COLS = set(INSERT_COLS) - DECIMAL_COLS - {'ingested_at'}
