...
TABLE = 'dwh.mysis_mstr_pagos'
STAGING = 'dwh.mysis_mstr_pagos_stg'
CONFIG_PATH = '/home/src/Maryun/io_config.yaml'
PROFILE = 'maryun'

# Full load atomico. El insert incremental no propagaba las bajas del origen:
# una nota de credito anulada en MySis quedaba viva en ClickHouse para
# siempre. Con staging + EXCHANGE TABLES la tabla queda identica al origen
# en cada corrida (altas, ediciones y bajas), sin ventana en que quede vacia.
MIN_RATIO = 0.5  # aborta si el origen trae menos de la mitad de lo que ya hay

INSERT_COLS = [
    'id', 'pago_id', 'importe', 'cliente_id', 'descripcion', 'usr_id', 'dt_in',
    'chebanco', 'chefecha', 'chenumero', 'caja_id', 'saldo', 'concilia_id',
    'deposito_banco', 'deposito_fecha', 'deposito_usr'
]

INT_COLS_NOTNULL     = {'id'}
INT_COLS_NULLABLE    = {'caja_id', 'cliente_id', 'concilia_id', 'deposito_banco', 'deposito_usr', 'pago_id', 'saldo', 'usr_id'}
