...
TABLE = 'dwh.mysis_mstr_nc_aux'
STAGING = 'dwh.mysis_mstr_nc_aux_stg_full'
CONFIG_PATH = '/home/src/Maryun/io_config.yaml'
PROFILE = 'maryun'

# Recarga completa atomica. El incremental por dt_in solo ve altas, asi que las
# lineas borradas o reinsertadas al editar una nota de credito nunca se
# propagaban. Medido: 123 filas de diferencia contra el origen. Con staging +
# EXCHANGE la tabla queda identica al origen en cada corrida.
MIN_RATIO = 0.5  # aborta si el origen trae menos de la mitad de lo ya cargado

# Orden EXACTO de SHOW CREATE TABLE dwh.mysis_mstr_nc_aux.
# ingested_at queda fuera a proposito: lo llena el DEFAULT now().
# nc_aux no tiene facturado ni precio_solicitado.
INSERT_COLS = [
...
INT_COLS_NOTNULL = {'posicion', 'picking'}
INT_COLS_NULLABLE = {'pid', 'qty', 'mda', 'reserva', 'entrega'}
DECIMAL_COLS_NOTNULL = {'descuento', 'pmp'}
...
DEC_PLACES = {'valor_2': 0}
DEC_NN_DEFAULTS = {'descuento': 0.0, 'pmp': 0.0}
INT_NN_DEFAULTS = {'picking': 0}
