...
TABLE = 'dwh.mysis_mstr_pedidos_creditos_pid'
STAGING = 'dwh.mysis_mstr_pedidos_creditos_pid_stg'
CONFIG_PATH = '/home/src/Maryun/io_config.yaml'
PROFILE = 'maryun'

# Full load atomico. El insert directo no propagaba las bajas del origen:
# una fila borrada en MySis quedaba viva en ClickHouse para siempre.
