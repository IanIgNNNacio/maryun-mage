...
TABLE = 'dwh.mysis_mstr_ingresos'
CONFIG_PATH = '/home/src/Maryun/io_config.yaml'
PROFILE = 'maryun'

INSERT_COLS = [
    'hid', 'proveedor_id', 'oc_id', 'dt_in', 'id_externo', 'dt_registro',
    'dt_llega', 'dt_cierre', 'usr_in', 'observacion', 'documento', 'guia',
    'sucursal_id', 'fechadocumento', 'fechaguia'
]

INT_COLS_NOTNULL  = {'hid'}
INT_COLS_NULLABLE = {'proveedor_id', 'oc_id', 'sucursal_id'}
STRING_COLS_NULLABLE = {
    'id_externo', 'usr_in', 'observacion', 'documento', 'guia'
}
DATE_COLS_DT64 = ['dt_in', 'dt_registro', 'dt_llega', 'dt_cierre']
DATE_COLS_D    = ['fechadocumento', 'fechaguia']
ALL_DATE_COLS  = DATE_COLS_DT64 + DATE_COLS_D
...
def export_data_to_clickhouse(df: pd.DataFrame, *args, **kwargs):
    """Insercion directa con ReplacingMergeTree. ClickHouse deduplica por hid."""
    client = _client()
