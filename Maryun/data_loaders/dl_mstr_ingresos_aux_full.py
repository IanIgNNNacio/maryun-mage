...
# Orden EXACTO de dwh.mysis_mstr_ingresos_aux (sin ingested_at: lo llena el DEFAULT).
# Esta tabla cuelga de hid (ingreso), no de pid, y no tiene las columnas
# comerciales de pedidos_aux/nc_aux.
COLS = ['posicion', 'hid', 'sku', 'qty', 'usr_in', 'dt_in', 'mda', 'pu']

DECIMAL_COLS = ['pu']
INT_NULLABLE_COLS = ['hid', 'qty', 'mda']
INT_NOTNULL_COLS = ['posicion']
...
def load_data(*args, **kwargs):
    """Lee mstr_ingresos_aux COMPLETA, recorriendo el rango de posicion por ventanas.
